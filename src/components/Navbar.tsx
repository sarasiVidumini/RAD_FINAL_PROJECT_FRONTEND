              ...
              {isStudent && (
                <div className="relative group/ai">
                  ...
                  <div className="pointer-events-none absolute top-full left-1/2 -translate-x-1/2 mt-3 opacity-0 group-hover/ai:opacity-100 transition-opacity duration-200 z-50">
                    <div
                      className="bg-zinc-900 border border-amber-500/20 text-amber-300 text-[10px] font-bold uppercase tracking-widest whitespace-nowrap px-3 py-1.5 rounded-lg shadow-xl"
                      style={{
            ...
            <>
              ...
              >
                ...
                <div className="relative w-9 h-9 bg-zinc-900 rounded-xl flex items-center justify-center border border-yellow-500/20 shadow-[0_0_15px_rgba(250,204,21,0.1)] overflow-hidden">
                  {user.avatarUrl ? (
                    <img
                      src={`${user.avatarUrl}`} // Adjust base URL as needed
                      alt="Profile"
            ...
            {user ? (
              <>
                ...
                <Link
                  ...
                  className="px-5 py-4 text-zinc-300 border border-white/10 rounded-xl mb-2"
                >
                  View Profile
                </Link>
